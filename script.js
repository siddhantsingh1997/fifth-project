...
const canvasCollision = document.getElementById('collisioncanvas')
...
class Particle {
    ...
    draw() {
        ...
        ctx.globalPath = 1 - this.radius/this.maxRadius;
        ctx.beginPath();
